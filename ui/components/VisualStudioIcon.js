const visualStudioOpen = require("../../system/visualStudio").visualStudioOpen;
...
class VisualStudioIcon extends HTMLElement {
  constructor(path) {
    super();
  ...
  _onClick() {
    visualStudioOpen(this.path);
  }
}
customElements.define("visual-studio-icon", VisualStudioIcon);
